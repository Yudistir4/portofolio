...
const about = () => {
    return (
        <motion.div variants={animateAbout} initial="initial" whileInView="animate" className="pt-20" id="about" >
            {/* <div className="relative flex h-screen w-full items-center justify-center"> */}
            < svg width="207" className='text-white' height="56" viewBox="0 0 207 56" fill="none" xmlns="http://www.w3.org/2000/svg" >
                ...
                <path
                    ...
                    strokeWidth="3"
                    className="stroke-primary-light bg-white"
                />

            </ svg>
            {/* </div> */}
            <div className="w-full flex items-center mb-8 text-center">
            ...
            <div className='flex text-center my-10 w-full justify-between'>
                <div className="flex flex-col gap-2">
                    <h4 className='text-2xl font-semibold text-white'>01+</h4>
                    <p>Years <br /> Experience</p>
                </div>
                <div className="flex flex-col gap-2">
                    <h4 className='text-2xl font-semibold text-white'>10+</h4>
